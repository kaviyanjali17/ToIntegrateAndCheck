...
public class UI_LoginPageTest extends BaseTest {
    ...
    @Test(priority = 3, dataProvider = "validSignupData")
    ...
    @Test(priority = 4, dataProvider = "invalidSignupData")
    ...
    @Test(priority = 5, dataProvider = "edgeCaseSignupData")
    ...
    @DataProvider
    public Object[][] validSignupData() throws IOException {
        return Excelutilities.getdata(projectpath + "\\src\\test\\resources\\testdata\\SignupData.xlsx", "ValidSignup");
    }

    @DataProvider
    public Object[][] invalidSignupData() throws IOException {
        return Excelutilities.getdata(projectpath + "\\src\\test\\resources\\testdata\\SignupData.xlsx", "InvalidSignup");
    }
    @DataProvider
    public Object[][] edgeCaseSignupData() throws IOException {
        return Excelutilities.getdata(projectpath + "\\src\\test\\resources\\testdata\\SignupData.xlsx", "EdgeCases");
    }
    @DataProvider
    public Object[][] loginEdgeCaseData() throws IOException {
        return Excelutilities.getdata(projectpath + "\\src\\test\\resources\\testdata\\SignupData.xlsx", "LoginEdgeCases");
    }
    @DataProvider(name = "validLoginData")
    public Object[][] validLoginData() throws IOException {
        return Excelutilities.getdata(projectpath + "\\src\\test\\resources\\testdata\\SignupData.xlsx", "ValidLogin");
    }   
}